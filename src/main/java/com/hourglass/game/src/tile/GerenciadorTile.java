package com.hourglass.game.src.tile;
...
public class GerenciadorTile {
    ...
    public GerenciadorTile(PainelJogo pj) {
        ...
        imagemTile();
        carregarMapa("/com/hourglass/game/assets/mapas/mapa03.txt"); // Caminho do mapa utilizado pelo metodo, evitando a criação de um novo metodo
    }
    ...
    public void imagemTile() {
        ...
        try {
            ...
            tile[0] = new Tile();
            tile[0].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/floor_1.png")));

            tile[1] = new Tile();
            tile[1].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/wall_1.png")));
            tile[1].colisao = true;

            tile[2] = new Tile();
            tile[2].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/water_1.png")));
            tile[2].colisao = true;

            tile[3] = new Tile();
            tile[3].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/dirt_1.png")));

            tile[4] = new Tile();
            tile[4].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/sand_1.png")));

            tile[5] = new Tile();
            tile[5].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/bush_1.png")));
            tile[5].colisao = true;

            tile[6] = new Tile();
            tile[6].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/stone_1.png")));
            tile[6].colisao = true;

            // Árvore grande

            tile[7] = new Tile();
            tile[7].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/tree_5.png")));
            tile[7].colisao = true;

            tile[8] = new Tile();
            tile[8].imagem = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/com/hourglass/game/assets/tile/tree_6.png")));
            tile[8].colisao = true;
