...
public class PainelJogo extends JPanel implements Runnable {
    ...
    public Player player = new Player(this, conTec, 0); // Inicializa o jogador com ID 0 por padrão
    ...
    player.jogadorId = scanner.nextInt();  
    System.out.println("Jogador selecionado: " + player.jogadorId);
    scanner.close();
    }
